            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>Edit Dosen</h4>
                        <a href="{{ route('dosensti.store') }}" class="btn btn-secondary">Kembali</a>
                    </div>
                        ...
                        <form action="{{ route('dosensti.update', $dosen->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nohp') is-invalid @enderror"
                                    id="nohp" name="nohp" value="{{ old('nohp', $dosen->nohp) }}">
                                @error('nohp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('bidang') is-invalid @enderror"
                                    id="bidang" name="bidang" value="{{ old('bidang', $dosen->bidang) }}"
                                    required>
                                @error('bidang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
